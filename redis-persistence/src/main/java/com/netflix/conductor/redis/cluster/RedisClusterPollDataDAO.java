...
public class RedisClusterPollDataDAO extends RedisPollDataDAO {

    public RedisClusterPollDataDAO() {
        super();
        this.configurator = new RedisClusterConfiguration();
    }

    public RedisClusterPollDataDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
