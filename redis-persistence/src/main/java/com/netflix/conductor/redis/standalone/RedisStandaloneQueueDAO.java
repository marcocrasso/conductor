...
public class RedisStandaloneQueueDAO extends DynoQueueDAO {

    public RedisStandaloneQueueDAO() {
        super();
        this.configurator = new RedisStandaloneConfiguration();
    }

    public RedisStandaloneQueueDAO(ConductorProperties conductorProperties, RedisProperties properties) {
