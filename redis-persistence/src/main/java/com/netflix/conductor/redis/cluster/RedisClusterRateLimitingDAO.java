...
public class RedisClusterRateLimitingDAO extends RedisRateLimitingDAO {

    public RedisClusterRateLimitingDAO() {
        super();
        this.configurator = new RedisClusterConfiguration();
    }

    public RedisClusterRateLimitingDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
