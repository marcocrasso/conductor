...
public class MySQLEventHandlerDAO extends MySQLBaseDAO implements EventHandlerDAO {
     ...
     */
    protected EventHandler getEventHandler(Connection connection, String name) {
