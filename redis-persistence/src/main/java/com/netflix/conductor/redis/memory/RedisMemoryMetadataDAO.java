...
public class RedisMemoryMetadataDAO extends RedisMetadataDAO {

    public RedisMemoryMetadataDAO() {
        super();
        this.configurator = new InMemoryRedisConfiguration();
    }

    public RedisMemoryMetadataDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
