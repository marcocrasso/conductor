...
public class RedisSentinelPollDataDAO extends RedisPollDataDAO {

    public RedisSentinelPollDataDAO() {
        super();
        this.configurator = new RedisSentinelConfiguration();
    }

    public RedisSentinelPollDataDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
