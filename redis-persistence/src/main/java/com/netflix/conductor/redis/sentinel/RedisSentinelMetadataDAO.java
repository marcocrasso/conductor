...
public class RedisSentinelMetadataDAO extends RedisMetadataDAO {

    public RedisSentinelMetadataDAO() {
        super();
        this.configurator = new RedisClusterConfiguration();
    }

    public RedisSentinelMetadataDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
