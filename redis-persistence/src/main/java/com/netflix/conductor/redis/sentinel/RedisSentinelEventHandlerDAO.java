...
public class RedisSentinelEventHandlerDAO extends RedisEventHandlerDAO {

    public RedisSentinelEventHandlerDAO() {
        super();
        this.configurator = new RedisSentinelConfiguration();
    }

    public RedisSentinelEventHandlerDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
