...
public class RedisMemoryPollDataDAO extends RedisPollDataDAO {

    public RedisMemoryPollDataDAO() {
        super();
        this.configurator = new InMemoryRedisConfiguration();
    }

    public RedisMemoryPollDataDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
