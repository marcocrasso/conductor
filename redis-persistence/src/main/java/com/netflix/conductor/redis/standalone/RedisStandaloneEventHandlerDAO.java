 ...
 */
package com.netflix.conductor.redis.standalone;
...
public class RedisStandaloneEventHandlerDAO extends RedisEventHandlerDAO {

    public RedisStandaloneEventHandlerDAO() {
        super();
        this.configurator = new RedisStandaloneConfiguration();
    }

    public RedisStandaloneEventHandlerDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
