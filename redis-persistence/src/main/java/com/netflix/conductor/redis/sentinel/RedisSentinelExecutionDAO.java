...
public class RedisSentinelExecutionDAO extends RedisExecutionDAO {

    public RedisSentinelExecutionDAO() {
        super();
        this.configurator = new RedisClusterConfiguration();
    }

    public RedisSentinelExecutionDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
