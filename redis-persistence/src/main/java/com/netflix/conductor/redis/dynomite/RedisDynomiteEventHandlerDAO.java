...
public class RedisDynomiteEventHandlerDAO extends RedisEventHandlerDAO {

    public RedisDynomiteEventHandlerDAO() {
        super();
        this.configurator = new DynomiteClusterConfiguration();
    }

    public RedisDynomiteEventHandlerDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
