...
public class RedisMemoryExecutionDAO extends RedisExecutionDAO {

    public RedisMemoryExecutionDAO() {
        super();
        this.configurator = new InMemoryRedisConfiguration();
    }

    public RedisMemoryExecutionDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
