...
public class RedisSentinelRateLimitingDAO extends RedisRateLimitingDAO {

    public RedisSentinelRateLimitingDAO() {
        super();
        this.configurator = new RedisSentinelConfiguration();
    }

    public RedisSentinelRateLimitingDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
