...
public class RedisClusterEventHandlerDAO extends RedisEventHandlerDAO {

    public RedisClusterEventHandlerDAO() {
        super();
        this.configurator = new RedisClusterConfiguration();
    }

    public RedisClusterEventHandlerDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
