...
public class RedisDynomiteMetadataDAO extends RedisMetadataDAO {

    public RedisDynomiteMetadataDAO() {
        super();
        this.configurator = new DynomiteClusterConfiguration();
    }

    public RedisDynomiteMetadataDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
