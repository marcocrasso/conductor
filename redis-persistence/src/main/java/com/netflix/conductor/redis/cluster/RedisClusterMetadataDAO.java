...
public class RedisClusterMetadataDAO extends RedisMetadataDAO {

    public RedisClusterMetadataDAO() {
        super();
        this.configurator = new RedisClusterConfiguration();
    }

    public RedisClusterMetadataDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
