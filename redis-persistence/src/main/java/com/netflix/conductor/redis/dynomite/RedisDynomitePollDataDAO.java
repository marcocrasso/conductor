...
public class RedisDynomitePollDataDAO extends RedisPollDataDAO {

    public RedisDynomitePollDataDAO() {
        super();
        this.configurator = new DynomiteClusterConfiguration();
    }

    public RedisDynomitePollDataDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
