...
public class RedisMemoryRateLimitingDAO extends RedisRateLimitingDAO {

    public RedisMemoryRateLimitingDAO() {
        super();
        this.configurator = new InMemoryRedisConfiguration();
    }

    public RedisMemoryRateLimitingDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
