...
public class RedisDynomiteExecutionDAO extends RedisExecutionDAO {

    public RedisDynomiteExecutionDAO() {
        super();
        this.configurator = new DynomiteClusterConfiguration();
    }

    public RedisDynomiteExecutionDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
