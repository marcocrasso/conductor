...
public class RedisDynomiteRateLimitingDAO extends RedisRateLimitingDAO {

    public RedisDynomiteRateLimitingDAO() {
        super();
        this.configurator = new DynomiteClusterConfiguration();
    }

    public RedisDynomiteRateLimitingDAO(JedisProxy jedisProxy, ObjectMapper objectMapper,
